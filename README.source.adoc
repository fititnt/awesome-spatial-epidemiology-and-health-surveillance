...
** Tier 1: very related to our main subject
** Tier 2: related with scientific area, but not necessary the use of spatial tecnology.
** Tier 3: related to the technology, but not not exclusive to epidemiology.

==== Tier 1

include::partials/github-topics_1.adoc[]

==== Tier 2
Reasonging: these topics are 

include::partials/github-topics_2.adoc[]
...
[%header,format=csv]
|===
include::data/general-concepts.hxl.csv[]
|===



include::partials/general-concepts.adoc[]
...
include::partials/software.adoc[]
